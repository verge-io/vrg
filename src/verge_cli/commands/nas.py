...
app = typer.Typer(
    ...
    help=(
        ...
        "    vrg nas volume create --service my-nas --name shared-data --size-gb 100 --tier 2\n\n"
        "    # Create a CIFS/SMB and an NFS share on that volume\n"
        "    vrg nas cifs create --volume shared-data --name smb-share\n"
        "    vrg nas nfs create --volume shared-data --name nfs-export\n\n"
        ...
        "    vrg nas files list shared-data --path /\n\n"
